...
// Direct combinational implementation of Table 1.
module lab03_arif_direct (input [3:0] SW, output reg [6:0] HEX0);
    always @* begin
        case (SW)
            ...
            default: HEX0 = 7'b1111111; // Blank for unknown simulation inputs.
        endcase
    end
endmodule
