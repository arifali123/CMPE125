...
set project_dir [file join $lab_dir build light_controller]
set project_file [file join $project_dir light_controller.xpr]
...
if {[llength [get_projects -quiet]] > 0} {
    ...
    create_project light_controller $project_dir -part $part
}
...
set_property top light_controller [get_filesets sources_1]
set_property top light_controller_tb [get_filesets sim_1]
set_property xsim.simulate.runtime 200ns [get_filesets sim_1]
